...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/babel-loader/lib/index.js?!./src/plugins/prettier/prettier.monaco.worker.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/babel-loader/lib/index.js?!./src/plugins/prettier/prettier.monaco.worker.ts":
/*!**************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--7-1!./src/plugins/prettier/prettier.monaco.worker.ts ***!
  \**************************************************************************************************/
/*! exports provided: PrettierWorker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PrettierWorker", function() { return PrettierWorker; });
...
var PrettierWorker = /*#__PURE__*/function (_BaseWorker) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_5__["default"])(PrettierWorker, _BaseWorker);

  var _super = _createSuper(PrettierWorker);

  function PrettierWorker(ctx, config) {
    var _this;

    Object(_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, PrettierWorker);

    _this = _super.call(this, ctx, config);

    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "options", void 0);

    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "loader", void 0);

    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "plugins", []);

    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "prettier", {});

    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "provideDocumentFormattingEdits", function _callee(model) {
      var _this$options, plugins, options, text, lines, formattedFulLRange, originalFullRange;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$options = _this.options, plugins = _this$options.plugins, options = Object(_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_1__["default"])(_this$options, ["plugins"]);
              console.log("[prettier] formatting");
              text = _this.prettier.format(model.getValue(), _objectSpread({
              ...
              originalFullRange = model.getFullModelRange();
              return _context.abrupt("return", [{
                range: originalFullRange.endLineNumber > formattedFulLRange.endLineNumber || originalFullRange.endLineNumber === formattedFulLRange.endLineNumber && originalFullRange.endColumn > formattedFulLRange.endColumn ? originalFullRange : formattedFulLRange,
                text: text
              }]);
    ...
    _this.loader = _this.importPrettier();
    return _this;
  }

  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(PrettierWorker, [{
    key: "importPrettier",
    value: function importPrettier() {
      var _iterator, _step, plugin;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function importPrettier$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_worker__WEBPACK_IMPORTED_MODULE_9__["importScript"])('https://unpkg.com/prettier@2.0.4/standalone.js'));

            case 2:
              // @ts-ignore
              this.prettier = prettier;
              _iterator = _createForOfIteratorHelper(this.options.plugins);
              _context2.prev = 4;
            ...
            case 6:
              ...
              plugin = _step.value;
              _context2.next = 10;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_worker__WEBPACK_IMPORTED_MODULE_9__["importScript"])("https://unpkg.com/prettier@2.0.4/".concat(plugin, ".js")));
      ...
      }, null, this, [[4, 14, 17, 20]], Promise);
    }
  }]);

  return PrettierWorker;
}(_worker__WEBPACK_IMPORTED_MODULE_9__["BaseWorker"]);
Object(_worker__WEBPACK_IMPORTED_MODULE_9__["initialize"])('prettier', PrettierWorker);
...
/******/ });
//# sourceMappingURL=prettier.monaco.worker.js.map